; Assembly program to sort a given list of integers in ascending order using Bubble Sort algorithm
...
inner_loop:
  ...
  jg swap ; Jump to swap if current value is greater than next value
